...
public class SandboxArreglos
{
    ...
    public void eliminarCadena( String cadena )
    {
    	arregloCadenas = Arrays.stream(arregloCadenas)
                .filter(c -> !c.equalsIgnoreCase(cadena))
                .toArray(String[]::new);
    }
    ...
    public void reiniciarArregloEnteros( double[] valores )
    {
    	arregloEnteros = Arrays.stream(valores)
                .mapToInt(v -> (int) v)  // Truncar el valor a int
                .toArray();
    }
    ...
    {
    	return (int) Arrays.stream(arregloEnteros).filter(v -> v == valor).count();
    }
    ...
    {
    	 return (int) Arrays.stream(arregloCadenas).filter(c -> c.equalsIgnoreCase(cadena)).count();
    }
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        return (int) histograma.values().stream().filter(count -> count > 1).count();
    }
